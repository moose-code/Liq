...
contract Liquid {
    // Liquivent, short for  liquidity event, is an permionssless and effcient
    // way to create protocol owned liquidity
    ...
    mapping(uint256 => LiquiventConfig) public liquiventConfig;

    //pack structs later
    struct LiquiventConfig {
        //time
        uint256 auctionLength;
        uint256 startTime;
        //accounting
    ...
    struct LiquiventInfo {
        uint256 totalRaised;
        uint256 totalLPTokensCreated;
        LiquiventState liquiventState;
    }
